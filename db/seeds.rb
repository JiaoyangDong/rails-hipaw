...
# require 'open-uri'
url="https://api.unsplash.com/search/photos?page=1&query=dog&client_id=Cu-bOxmHNpsY4DftpFskX6nkbRH6JUnUoR9QbYHN2-g"
dogs = JSON.parse(URI.open(url).read )["results"].first(10)
